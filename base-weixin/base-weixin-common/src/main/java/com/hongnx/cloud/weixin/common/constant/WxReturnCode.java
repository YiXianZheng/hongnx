...
public enum WxReturnCode {
	...
	ERR_40054("40054", "button url无效，需带上'http://'"){},
	...
	ERR_200002("200002", "入参错误，请查看详细报错日志 "){},

	ERR_300002("300002", "名称长度不符合规则"){},
	ERR_300003("300003", "价格输入不合规（如：现价比原价大、传入价格非数字等）"){},
	ERR_300010("300010", "商品审核状态不对（如：商品审核中）"){},
	ERR_300011("300011", "操作非法（API不允许操作非API创建的商品）"){},
	ERR_300014("300014", "审核中，无法删除"){},
	ERR_300018("300018", "商品图片尺寸过大"){},
	ERR_300023("300023", "当前房间状态不允许此操作"){},
	ERR_300030("300030", "主播微信号不合法"){},
	ERR_300036("300036", "主播微信号未实名认证"){},
	ERR_300039("300039", "主播副号微信号不合法"){},
	 ...
	 * @return
	 */
	public static R wxErrorExceptionHandler(WxErrorException e){
		Integer errorCode = e.getError().getErrorCode();
		return R.failed(WxReturnCode.getMsg("ERR_"+errorCode));
	}
