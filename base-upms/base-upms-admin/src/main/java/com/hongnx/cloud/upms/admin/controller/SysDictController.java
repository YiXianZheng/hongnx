...
import com.hongnx.cloud.upms.admin.service.SysDictService;
import com.hongnx.cloud.upms.admin.service.SysDictValueService;
import com.hongnx.cloud.upms.common.entity.SysDict;
...
public class SysDictController {
	...
	public R getSysDictItemPage(Page page, SysDictValue sysDictValue) {
		return R.ok(sysDictValueService.page(page, Wrappers.query(sysDictValue).orderByAsc("sort")));
	}
