...
import com.hongnx.cloud.upms.admin.mapper.SysOrganRelationMapper;
...
public class SysOrganRelationServiceImpl extends ServiceImpl<SysOrganRelationMapper, SysOrganRelation> implements SysOrganRelationService {
	 ...
	 */
	@Override
	public void updateOrganRealtion(SysOrganRelation sysOrganRelation) {
		baseMapper.updateOrganRelations(sysOrganRelation);
	}
